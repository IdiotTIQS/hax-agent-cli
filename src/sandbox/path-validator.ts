...
class PathViolationError extends Error { constructor(m: string) { super(m); this.name = "PathViolationError"; } }

function validateWorkspacePath(targetPath: string, workspaceRoot: string) {
...
function validatePath(targetPath: string, workspaceRoot: string) {
