...
function loadClaudeMd(cwd?: string): Array<{ file: string; content: string }> { const sources: Array<{ file: string; content: string }> = []; let current=path.resolve(cwd||process.cwd());
