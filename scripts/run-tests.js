...
const nodeArgs = ['--test', 'test/smoke-test.test.js', 'test/public-api.test.js', 'test/pricing-fix.test.js', 'test/pricing-fallbacks.test.js', 'test/permissions-checker.test.js', 'test/cost-tracker.test.js', 'test/lsp.test.js', 'test/anthropic-provider.test.js', 'test/engine-system-prompt.test.js', 'test/engine-tool-result.test.js'];
